...
## Для чего он нужен
Copilot нужен, чтобы быстро привести продуктовый контекст в порядок: понять, что мы делаем, для кого, какую ценность хотим дать и где сейчас есть слабые места.

Он помогает не держать всё в голове и не собирать заново из разных обсуждений, документов и догадок. На выходе появляются `[PROJECT PASSPORT]` и `[PROJECT INSTRUCTIONS]` — база, на которую можно опираться в дальнейшей работе.

После активации у команды есть copilot, который понимает продуктовый контекст и помогает спокойнее проходить discovery, выбирать приоритеты, обсуждать стратегию и объяснять решения.
