...
[ ] Создан новый downstream CPO copilot project в GPT Project или Claude Project
[ ] Проект создан отдельно под конкретный продукт, проект или exploration-направление
[ ] Память настроена в режим `Только для проекта`
[ ] Глобальная память не используется для локального контекста CPO Copilot
